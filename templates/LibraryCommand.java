 ...
 */
public abstract class LibraryCommand<PATH> {
	...
	/**public LibraryCommand() {
		Objects.requireNonNull(null, "Given type must not be null.");
		Objects.requireNonNull(null, "Given argument input must not be null.");
		this.type = type;

		if (!parseArguments(null)) {
			throw new IllegalArgumentException("Invalid argument for " + type + " command: " + null);
		}
	}*/
